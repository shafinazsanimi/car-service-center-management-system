        ...
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
					...
					<div class="col-sm-6">
						...
						<input type="text" name="search" id="search_text" class="form-control form-control-md border-secondary" style="width:500px" placeholder="Search ID / Type / Description / Customer Name / Status">
			...
			<table class="table table-bordered" id="table-data">
				...
				<tbody>
						...
						{ ?>
						<tr class='clickable-row text-primary' data-href='/fyp/supervisor/service/display.php?id=<?php echo $row['svc_id']; ?>'>
