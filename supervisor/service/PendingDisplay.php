...
<div class="card-body">
	<button onclick="window.location.href='PendingList.php'" class="btn btn-secondary btn-sm mb-3"><i class="fa fa-arrow-left"></i> Back To List</button>
</div>
	...
	$('#deleterec').click(function(){
		$.ajax({
			...
			success:function(data){
            	...
            	window.location = "/fyp2/supervisor/service/list.php";
			}
		});
	});
