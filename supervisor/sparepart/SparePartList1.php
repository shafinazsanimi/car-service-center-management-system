...
<body>
    ...
    <div class="container" style="margin-top:50px">
        <div class="table-wrapper">
            ...
            <?php
					include 'connectionDB.php';
					$stmnt=$con->prepare("SELECT sp_id,sp_type,sp_brand,sp_desc,sp_stock FROM sparepart WHERE sp_type='Tyre'");
					$stmnt->execute();
			...
			<table class="table table-bordered" id="table-data">
				...
				<tbody>
						...
						{ ?>
						<tr class='clickable-row text-primary' data-href='/fyp/supervisor/sparepart/SparePartDisplay1.php?id=<?php echo $row['sp_id']; ?>'>
							<td><u><?= $row['sp_id']; ?></u></td>
