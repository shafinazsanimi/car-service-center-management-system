...
<div class="card-body">
	<button onclick="window.location.href='SparePartList0.php'" class="btn btn-secondary btn-sm mb-3"><i class="fa fa-arrow-left"></i> Back To List</button>
</div>  
	...
	$('#deleterec').click(function(){
		$.ajax({
			...
			success:function(data){
            	...
            	window.location = "SparePartList0.php";
			}
		});
	});
