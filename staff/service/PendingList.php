    ...
    <div class="container" style="margin-top:50px">
        <div class="table-wrapper">
            ...
            <?php
					...
					$stmnt=$con->prepare("SELECT * FROM service INNER JOIN customer ON service.cust_id = customer.cust_id WHERE svc_paymentstatus='Pending'");
					$stmnt->execute();
			...
			<table class="table table-bordered" id="table-data">
				...
				<tbody>
						...
						{ ?>
						<tr class='clickable-row text-primary' data-href='/fyp/staff/service/PendingDisplay.php?id=<?php echo $row['svc_id']; ?>'>
