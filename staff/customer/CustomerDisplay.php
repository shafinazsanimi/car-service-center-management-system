...
<div class="modal fade" id="deleteData" tabindex="-1" role="dialog" aria-labelledby="deleteLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="deleteLabel">Are you sure want to delete this customer?</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
    		...
    		<div class="modal-content">
      			...
      			<form method="POST" id="add_rec">
	      			<div class="modal-body">
						...
						<div class="form-group">
							<label for="sp_used"><b>Quantity of Spare Part Used</b></label>
...
$(document).ready(function(){
	...
	$('#addrec').click(function(e){
		...
		$.ajax({
			...
			success:function(data){
				alert("Service has been successfully added for this customer!");
